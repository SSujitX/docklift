  ...
  <section id="terminal" className="scroll-mt-20 mb-12 text-left">
    ...
    <div className="bg-secondary/50 rounded-xl p-6 mb-4">
      ...
      <ul className="list-disc list-inside text-muted-foreground space-y-1">
        ...
        <li><strong>Step-up password</strong>: Host actions and the root shell all require your account password again (JWT alone is not enough). Cancel aborts — the action does not continue</li>
        <li><strong>Upgrade / update dialogs</strong>: Confirm before start (panel offline + target version); password; then a wait dialog with refresh timing (Esc/overlay locked until countdown ends)</li>
