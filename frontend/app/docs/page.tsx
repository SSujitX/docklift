...
const sections = [
  ...
  { id: "reset-password", title: "Reset Password", icon: ShieldCheck },
...
PORT=3000`} 
              ...
              {/* Profile Management */}
              <section id="profile" className="scroll-mt-20 mb-12">
                <h2 className="flex items-center gap-2 text-2xl font-bold mb-4">
              ...
              {/* Reset Password */}
              <section id="reset-password" className="scroll-mt-20 mb-12">
                <h2 className="flex items-center gap-2 text-2xl font-bold mb-4">
